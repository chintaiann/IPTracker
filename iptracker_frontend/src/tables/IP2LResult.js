...
export default function IP2LResult({rowData}) {
 ...
 const [columnDefs, setColumnDefs] = useState(
    [    {field: "enteredip",headerName:"IP"},    {field: "countryName"},    {field: "cityName"},    {field: "regionName"},    {field: "isp"},    {field: "usageType"},    {field: "latitude"},    {field: "longitude"}]
